...
def main():
    ...
    while True:
        try:
            ...
            if Config.TTS_MODEL == 'openai' or Config.TTS_MODEL == 'elevenlabs' or Config.TTS_MODEL == 'melotts' or Config.TTS_MODEL == 'cartesia' or Config.TTS_MODEL== 'prosa':
            ...
            if Config.TTS_MODEL=="cartesia":
                ...
                logging.info(Fore.CYAN + "Bot Said: " + Fore.RESET)
