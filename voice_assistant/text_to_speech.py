...
def text_to_speech(model: str, api_key:str, text:str, output_file_path:str, api_key_2:str=None, local_model_path:str=None):
    """
    ...
    try:
        if model == 'openai':
            ...
            client = Prosa.TTS(api_key)
            audio = client.get_speech(text)
