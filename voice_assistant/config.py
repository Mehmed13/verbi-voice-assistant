...
class Config:
    ...
    Attributes:
        TRANSCRIPTION_MODEL (str): The model to use for transcription ('openai', 'groq', 'deepgram', 'fastwhisperapi', 'local', 'prosa').
        RESPONSE_MODEL (str): The model to use for response generation ('openai', 'groq', 'local').
        TTS_MODEL (str): The model to use for text-to-speech ('openai', 'deepgram', 'elevenlabs', 'local', 'prosa').
    ...
    """
    # Model selection
    TRANSCRIPTION_MODEL = 'prosa'  # possible values: openai, groq, deepgram, fastwhisperapi, prosa
    RESPONSE_MODEL = 'groq'  # possible values: openai, groq, ollama
    TTS_MODEL = 'prosa'  # possible values: openai, deepgram, elevenlabs, melotts, cartesia, prosa
    ...
    def validate_config():
        ...
        Config._validate_model('TRANSCRIPTION_MODEL', [
            'openai', 'groq', 'deepgram', 'fastwhisperapi', 'local', 'prosa'])
        Config._validate_model('RESPONSE_MODEL', [
            'openai', 'groq', 'ollama', 'local'])
        Config._validate_model('TTS_MODEL', [
            'openai', 'deepgram', 'elevenlabs', 'melotts', 'cartesia', 'local', 'prosa'])
        ...
        Config._validate_api_key('TRANSCRIPTION_MODEL', 'prosa', 'PROSA_STT_API_KEY')
        ...
        Config._validate_api_key('TTS_MODEL', 'prosa', 'PROSA_TTS_API_KEY')
